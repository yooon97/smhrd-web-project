		...
		<div id='custom-popup' class="needpopup"
			...
			<form method="post" action="imageuploadtest" enctype="multipart/form-data">
				...
				<tr bgcolor="whitesmoke" height="30px" >
						<td align="center" colspan="2"><textarea cols="50" rows="2" name="title" id="title"></textarea></td>
				</tr>
				
				
				<tr bgcolor="whitesmoke">
					<td align="center" name="cate" id="cate">카테고리</td>
					<td><select>
				...
				<tr bgcolor="whitesmoke" height="30px">
						...
						<input type="file" id="chooseFile" name="photo" accept="image/*" onchange="loadFile(this)">
						</td>
				</tr>
				...
				<tr bgcolor="whitesmoke" height="30px">
						...
						<div>
							<textarea style="width: 380px; height: 380px;" cols="50"rows="3"></textarea>
						</div>
						</td>
				</tr>
				<tr>
