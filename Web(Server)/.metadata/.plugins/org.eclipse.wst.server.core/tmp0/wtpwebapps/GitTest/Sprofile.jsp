					...
					<div class="col-sm-12">
						<div class="contact_contant sections">
							<div class="head_title text-center">
								<h2>회원정보란</h2>
								<div class="subtitle">
									<span><%=profile.get(0).getUser_id()%>님 환영합니다.</span>
								</div>
								<div class="separator"></div>
								<section class="container3">
									<article class="half">
										<h1>회원수정</h1>
										<div class="tabs">
											<span class="tab signin active"><a href="#signin">ㅤㅤ닉네임ㅤㅤ</a></span>
										</div>
										<div class="content">
											<div class="signin-cont cont">
												<form action="Sprofilesend" method="post">
													<input type="text" name="nick" id="nick" class="inpt"
														value="<%=profile.get(0).getUser_nick()%>">
													<div class="tabs">
														<span class="tab signin active"><a href="#signin">상태메세지</a></span>
													</div>
													<textarea id="status" name="status"
														style="width: 170px; height: 100px;" cols="50" rows="3"
														maxlength="200"><%=profile.get(0).getUser_status()%></textarea>
