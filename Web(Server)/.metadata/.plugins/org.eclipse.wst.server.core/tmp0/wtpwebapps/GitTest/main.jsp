...
<body class="is-preload">
   ...
   <div id="header">
        ...
        <!-- Logo -->
         <div id="logo">
            ...
            <%
               ...
               %><h1 id="title"><%= dto.getUser_nick() %>님 환영합니다.</h1>
               <p>로그인 환영합니다.</p>
            <%
            } %>
         </div>
         ...
         <nav id="nav">
            ...
            <ul>
               ...
               <li><a href="delete.jsp" id="about-link"><span class="icon solid fa-user">회원삭제</span></a></li>
               <% if (dto == null) {%>
      ...
      <div class="bottom">
         ...
         <ul class="icons">
            ...
            <li><a href="https://github.com/2022-SMHRD-KDT-BigData-4/TRAVELARY_first_project"
   ...
   <div id="main">
      ...
      <section id="top" class="one dark cover">
		...
		<footer>
								<a href="#portfolio" class="button scrolly">추천글보러가기</a>
							</footer>
