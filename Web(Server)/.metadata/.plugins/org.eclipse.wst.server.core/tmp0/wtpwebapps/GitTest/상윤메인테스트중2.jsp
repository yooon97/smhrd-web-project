...
<section class="clock">
  ...
  <div class="cercle"></div>
                     ...
                     <!-- 지도 넣는 부분 -->
                        ...
                        <div id="sead">
                        주소 검색<input type="text" name="address" value="" id="address"><button onclick="searchaddress()">검색</button>
...
<script>
                  ...
                  <div class="wrapper">
                     <a href="#" data-needpopup-show="#small-popup">작은팝업</a> <a
                        ...
                        data-needpopup-show="#custom-popup">게시물작성</a>
		    ...
		    <article class="half">
			        <h1>Posting</h1>
			        <div class="tabs">
				            <span class="tab signin active"><a href="#signin">정보입력란</a></span>
			        </div>
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="imageuploadtest" method="post" enctype="multipart/form-data">
				            				...
				            				<span class="tab signin active"><a href="#signin">본문작성란</a></span>
			        						</div>
