  ...
  <div class="culmn">
    ...
    <section id="contact" class="contact">
               ...
               <div class="col-sm-12">
                  <div class="contact_contant sections">
                     <div class="head_title text-center">
                        <h2>전체 회원 목록</h2>
                        <div class="subtitle">팔로우할 회원을 찾아보세요.</div>
                        <div class="separator"></div>
                     </div>
                     <!-- End off Head_title -->
                     <div class="row"></div>
         ...
         <form method="post" action="followsearch">
                ID : <input type="text" name="follow_partner"> 
        ...
        <%
        List<Member> search = (List)session.getAttribute("searchList");
        String follow_partner = (String)session.getAttribute("follow_partner");
        ...
        <tr>
          ...
          <th scope="cols">상태메세지</th>
          <th scole="cols">팔로우</th>
        </tr>
        </thead>
        
          <tr>
          <th scope="row"><%=search.get(0).getUser_id() %></td>
          <td><%=search.get(0).getUser_nick()%></td>
          <td><%=search.get(0).getUser_status()%></td>
          <td><a href="Sfollowinsert?follow_partner=${follow_partner}">추가</a></td></tr>
