         ...
         <div class="main_menu_bg">
            <div class="container">
              ...
              <ul class="nav navbar-nav navbar-right">
                      ...
                      <li><a href="seletPostCon">Myhome</a></li>
                      <li><a href="selectMar1">post</a></li>
              ...
              <script>
                  ...
                  $(document).on('click','#nologinpost',function(){
                      alert('로그인을 해주세요!');
                    });
              </script>
         ...
         <div class="container">
            <div class="row">
               <div class="main_feature text-center">
                  <div class="col-sm-3" id = "pass-icon1">
                  ...
                  <div class="col-sm-3" id = "pass-icon2">
                     <div class="single_feature">
...
<!-- 
 ...
 -->
                  <div class="col-sm-3" id = "pass-icon3">
                     <div class="single_feature">
               ...
               <div class="col-sm-12">
                  <div class="contact_contant sections">
                     <div class="head_title text-center">
                        <h2 id="maptitle">Making memories</h2>
                     ...
                     <!-- 지도 넣는 부분 -->
                        <div id="sead"><div id="address-text">
                        도로명주소 검색</div><input type="text" name="address" value="" id="address"><button onclick="searchaddress()" class="ml-btn-4">검색</button>
                        </div> 
                        <div id="sead2"><div id="keyword-text">
                        키워드 검색</div><input type="text" name="keyword" value="" id="keyword"><button onclick="keywordgo()" class="ml-btn-4">검색</button>
                        </div>

                        <div>
                        <div class="category-div">
                        <div class="ml-btn-4 rounded" id="categoryss">
                           <div>Category</div>
                        </div>
                                            ...
                                            <div class="signin-cont cont">
                                                  <form action="imageuploadtest" method="post" enctype="multipart/form-data">
                                                      ...
                                                      <input type="hidden" id="user_id" name="user_id" value="<%=id %>">
                                                        ...
                                                        <input type="file" name="file1" id="photo" class="inpt"   accept="image/*" onchange="loadFile(this)" placeholder="사진입력">
                                                                     <div class="fileContainer">
                                                                        <div class="fileInput">
                                                                           <p id="fileName" name="file" class="hidden"></p>
                                                                        </div>
                                              ...
                                              <textarea id="newpost1" name="post"
                                                                           style="width: 380px; height: 380px;" cols="50" rows="3" required="required"></textarea>
