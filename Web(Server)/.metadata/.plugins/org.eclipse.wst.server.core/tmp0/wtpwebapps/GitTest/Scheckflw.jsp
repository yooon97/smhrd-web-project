								...
								<div class="main_home_slider text-center">
									<div class="single_home_slider">
										<div class="main_home wow fadeInUp" data-wow-duration="700ms">
											...
											<div class="home_btn">
												<a href="Sfollow.jsp" class="btn btn-lg m_t_10">전체회원조회</a>
												<a href="selectmyfolCon" class="btn btn-default">내 팔로우확인</a>
					...
					<div class="col-sm-12">
						<div class="contact_contant sections">
							<div class="head_title text-center">
								<h2>내가 팔로우하는 사람들</h2>
								<div class="subtitle">내 팔로우 목록입니다.</div>
								<div class="separator"></div>
							</div>
							<!-- End off Head_title -->
							<div class="row"></div>
							...
							%>
							<form method="post" action="followsearch">
								ID : <input type="text" name="follow_partner" id="follow_partner"> 
							...
							<%
							List<Follow> selectfollower = (List)session.getAttribute("selectfollower");
							%>
						<div class="tableDiv">
<table class="type09">
				<thead>
				<tr>
					...
					<th scope="cols" id="timeline">친구삭제</th>
				</tr>
				</thead>
				
				<% for(int i=0; i<selectfollower.size(); i++)  {%>
				<tr>
				<th scope="row"><%=selectfollower.get(i).getFollow_partner()%></td>
				<td><a href="selectFolMar?user_id=<%=selectfollower.get(i).getFollow_partner()%>">보기</a></td>
				<td><a href="DeleteFolCon?partnerid=<%=selectfollower.get(i).getFollow_partner()%>">삭제</a></td>
				</tr><%}; %>
				</tbody>
				</table>
					...
					<div class="main_feature text-center">
						...
						<div class="col-sm-3">
							<div class="single_feature">
								<div OnClick="location.href ='#history'" style="cursor:pointer;" class="single_feature_icon">
						...
						<div class="col-sm-3">
							<div class="single_feature">
								<div OnClick="location.href ='#service'" style="cursor:pointer;" class="single_feature_icon">
						...
						<div class="col-sm-3">
							<div class="single_feature">
								<div OnClick="location.href ='#portfolio'" style="cursor:pointer;" class="single_feature_icon">
						...
						<div class="col-sm-3">
							<div class="single_feature">
								<div OnClick="location.href ='#team'" style="cursor:pointer;" class="single_feature_icon">
