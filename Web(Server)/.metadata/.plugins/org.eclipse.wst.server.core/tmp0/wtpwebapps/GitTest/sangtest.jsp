...
<%
 ...
 <% for(int i = 0; i<CarPo1.size(); i++){
     %>basic1.push({content : '<div>글 제목 : <%=CarPo1.get(i).getTitle() %></div><div>작성자 : <%=CarPo1.get(i).getUser_id() %></div><div>작성일자 : <%=CarPo1.get(i).getPost_dt()%></div><br>ㅤㅤㅤㅤㅤ'});<%

 }%>
 <% for(int i = 0; i<CarPo2.size(); i++){
     %>healing1.push({content : '<div>글 제목 : <%=CarPo2.get(i).getTitle() %></div><div>작성자 : <%=CarPo2.get(i).getUser_id() %></div><div>작성일자 : <%=CarPo2.get(i).getPost_dt()%></div><br>ㅤㅤㅤㅤㅤ'});<%

 }%>
 <% for(int i = 0; i<CarPo3.size(); i++){
     %>store1.push({content : '<div>글 제목 : <%=CarPo3.get(i).getTitle() %></div><div>작성자 : <%=CarPo3.get(i).getUser_id() %></div><div>작성일자 : <%=CarPo3.get(i).getPost_dt()%></div><br>ㅤㅤㅤㅤㅤ'});<%

 }%>
 <% for(int i = 0; i<CarPo4.size(); i++){
     %>pet1.push({content : '<div>글 제목 : <%=CarPo4.get(i).getTitle() %></div><div>작성자 : <%=CarPo4.get(i).getUser_id() %></div><div>작성일자 : <%=CarPo4.get(i).getPost_dt()%></div><br>ㅤㅤㅤㅤㅤ'});<%

 }%>
 <% for(int i = 0; i<CarPo5.size(); i++){
     %>travel1.push({content : '<div>글 제목 : <%=CarPo5.get(i).getTitle() %></div><div>작성자 : <%=CarPo5.get(i).getUser_id() %></div><div>작성일자 : <%=CarPo5.get(i).getPost_dt()%></div><br>ㅤㅤㅤㅤㅤ'});<%
