<%@page import="com.smhrd.controller.LoginCon"%>
      ...
      <div id="main">
         ...
         <div class="inner">
            ...
            <c:choose>
               ...
               System.out.println("메시지 개수 : " + messageList.size());

               %>
               
                  <li>${loginMember.email }님에게 온 메시지입니다.</li>
                  <li><a href="DeleteAllMessageCon?loginMember.email=${loginMember.email}" class="button next scrolly">전체삭제하기</a></li>
               <table>
               <c:forEach var="msg" items="${messageList }" varStatus="status">
                  <tr>
                     <td>${status.count }</th>
                     <td>보낸 회원 이메일 : <c:out value="${msg.sendEmail}"></c:out></td>
                     <td>내용 : <c:out value="${msg.message}"></c:out></td>
                     <td>보낸시간 : <c:out value="${msg.date }"></c:out></td>
      ...
      <div class="inner">
         ...
         <form action="SendMessageCon" method="post">
            <div class="field half first">
               <label for="name">Name</label> <input type="text" name="sendEmail" value="${loginMember.email}" readonly id="name"
                  placeholder="보내는 사람 이름" />
            </div>
            <div class="field half">
               <label for="email">Email</label> <input type="text" name="receiveEmail"
