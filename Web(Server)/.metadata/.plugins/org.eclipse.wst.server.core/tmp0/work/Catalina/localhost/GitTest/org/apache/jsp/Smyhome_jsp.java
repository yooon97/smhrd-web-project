 ...
 * Generated at: 2022-05-25 12:11:01 UTC
...
public final class Smyhome_jsp extends org.apache.jasper.runtime.HttpJspBase
...
System.out.print(selectfollower.get(1).getFollow_partner());
 ...
 for(int i = 0; i<selectfollower.size(); i++) { 
  ...
  String user_id = (String)session.getAttribute("user_id");
   ...
   //System.out.print("테스트 : " + postList.get(0).getPost());
      ...
      out.print(marList.get(0).getLATITUDE());
      out.write(',');
      out.write(' ');
      out.print(marList.get(0).getLONGITUDE());
      out.write("), // 지도의 중심좌표\r\n");
 ...
 for(int i = 0; i<marList.size(); i++) { 
      ...
      out.print(marList.get(i).getLATITUDE());
      out.write(',');
      out.write(' ');
      out.print( marList.get(i).getLONGITUDE());
      out.write("))\r\n");
};
      out.write("\r\n");
      out.write("\r\n");
 for(int i =0; i<marList.size(); i++) {
      out.write("\r\n");
      out.write("positions.push({title: '<div>제목 : ");
      out.print(postList.get(i).getTitle());
      out.write("</div> <div>내용 : ");
      out.print(postList.get(i).getPost());
      out.write("</div><div>작성일자 : ");
      out.print(postList.get(i).getPost_dt());
      out.write("</div>',  \r\n");
      ...
      out.write("\r\n");
      out.write("//console.log(positions[0].content)\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
 for(int i =0; i<marList.size(); i ++) {
      ...
      out.print(marList.get(i).getMarker_shape());
      out.write(')');
      out.write('\r');
      out.write('\n');
}
      ...
      out.write("        position: positions[i].latlng, // 마커를 표시할 위치 // 마커의 타이틀, 마커에 마우스를 올리면 타이틀이 표시됩니다\r\n");
      out.write("        image : markerImage // 마커 이미지\r\n");
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write("    // 마커에 표시할 인포윈도우를 생성합니다 \r\n");
      out.write("    var infowindow = new kakao.maps.InfoWindow({\r\n");
      out.write("        content: positions[i].title // 인포윈도우에 표시할 내용\r\n");
      out.write("    });\r\n");
      out.write("  \r\n");
      out.write("\r\n");
      ...
      out.write("<thead>\r\n");
      out.write("<tr>\r\n");
      out.write("<th scope=\"cols\" id=\"id\">게시물 제목</th>\r\n");
      out.write("<th scope=\"cols\" id=\"timeline\">게시물 내용</th>\r\n");
      out.write("<th scope=\"cols\" id=\"timeline\">작성일자</th>\r\n");
      out.write("\r\n");
      out.write("</tr>\r\n");
      out.write("</thead>\r\n");
      out.write("<tbody>\r\n");
 ...
 for(int i = 0; i<postList.size(); i++) { 
      ...
      out.print( postList.get(i).getPost_dt());
      out.write("</th>\r\n");
      out.write("<th><a href=\"spostreviseseenow?posttitle=");
      out.print( postList.get(i).getTitle());
      out.write("&post_dt=");
      out.print( postList.get(i).getPost_dt());
      out.write("\">수정</a>ㅤㅤㅤㅤ<a href=\"DeletePostCon?post_seq=");
      out.print( postList.get(i).getPost_seq());
      out.write(" \">삭제</a></th>\r\n");
}; 
