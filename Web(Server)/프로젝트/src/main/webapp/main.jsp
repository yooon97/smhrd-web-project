...
<body class="is-preload">
	...
	<div id="header">
		...
		<div class="top">
			...
			<nav id="nav">
				<ul>
					<li><a href="main.jsp" id="top-link"><span
							class="icon solid fa-home">Main</span></a></li>
					<li><a href="#portfolio" id="portfolio-link"><span
							class="icon solid fa-th">Best-post</span></a></li>
					<li><a href="Login.jsp" id="about-link"><span
							class="icon solid fa-user">Login</span></a></li>
					<li><a href="#contact" id="contact-link"><span
							class="icon solid fa-envelope">Friend</span></a></li>
				</ul>
			</nav>
